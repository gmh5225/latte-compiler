...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_PLUSASSIGN = 34,                /* PLUSASSIGN  */
  YYSYMBOL_MINUASSIGN = 35,                /* MINUASSIGN  */
  YYSYMBOL_MULASSIGN = 36,                 /* MULASSIGN  */
  YYSYMBOL_DIVASSIGN = 37,                 /* DIVASSIGN  */
...
{
       0,    43,    43,    48,    49,    54,    55,    56,    57,    58,
      59,    62,    77,    83,    82,    93,    96,   102,   108,   112,
     116,   119,   126,   128,   134,   142,   144,   152,   154,   162,
     164,   171,   174,   180,   190,   190
};
#endif
...
static const char *const yytname[] =
{
  ...
  "FLOATNUM", "IF", "ELSE", "INT", "VOID", "FLOAT", "LPAREN", "RPAREN",
  "LBRACE", "RBRACE", "SEMICOLON", "LSQUARE", "RSQUARE", "ADD", "SUB",
  "MUL", "DIV", "MOD", "OR", "AND", "NOT", "MINUS", "EQ", "GEQ", "LEQ",
  "NEQ", "GRA", "LES", "ASSIGN", "PLUSASSIGN", "MINUASSIGN", "MULASSIGN",
  "DIVASSIGN", "CONST", "WHILE", "BREAK", "CONTINUE", "RETURN", "THEN",
  "$accept", "Program", "Stmts", "Stmt", "LVal", "AssignStmt", "BlockStmt",
  "$@1", "IfStmt", "ReturnStmt", "Exp", "Cond", "PrimaryExp", "AddExp",
  "RelExp", "LAndExp", "LOrExp", "Type", "DeclStmt", "FuncDef", "$@2", YY_NULLPTR
};
...
{
      12,   -21,    11,   -21,   -21,   -21,     6,     5,    12,   -21,
     -10,   -21,   -21,   -21,   -21,    23,   -21,   -21,     6,    12,
     -21,   -21,    14,   -21,    -5,   -21,   -21,     6,    15,    19,
      -5,     1,     3,     9,    -2,   -21,     6,     6,    21,   -21,
      26,    12,     6,     6,     6,   -21,   -21,   -21,   -21,    30,
      31,    -5,     1,     3,    32,    12,   -21,   -21
};
...
{
       0,    11,     0,    31,    32,    13,     0,     0,     2,     3,
       0,     5,     6,     7,     8,     0,     9,    10,     0,     0,
      21,    20,     0,    22,    18,     1,     4,     0,    34,     0,
      25,    27,    29,    19,     0,    17,     0,     0,     0,    33,
       0,     0,     0,     0,     0,    14,    23,    24,    12,     0,
      15,    26,    28,    30,     0,     0,    35,    16
};

/* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
{
     -21,   -21,    24,    -6,     0,   -21,    -8,   -21,   -21,   -21,
      17,   -21,   -20,    -3,     4,     7,   -21,   -21,   -21,   -21,
     -21
};
...
{
       0,     7,     8,     9,    21,    11,    12,    19,    13,    14,
      22,    29,    23,    30,    31,    32,    33,    15,    16,    17,
      40
};
...
{
      10,     1,    26,    24,     2,    25,     3,     4,    10,     1,
      20,     5,    45,    36,    37,     1,    46,    47,     2,    10,
       3,     4,    18,    27,    24,     5,    28,    43,    26,    35,
      39,    41,    44,    42,    10,    50,    48,    49,    55,    51,
       6,    10,    54,    34,    38,     5,    56,    52,     0,    57,
       0,    53,     0,     0,     6,    10
};
...
{
       0,     3,     8,     6,     6,     0,     8,     9,     8,     3,
       4,    13,    14,    18,    19,     3,    36,    37,     6,    19,
       8,     9,    11,    33,    27,    13,     3,    24,    34,    15,
      15,    12,    23,    32,    34,    41,    15,    11,     7,    42,
      42,    41,    12,    19,    27,    13,    54,    43,    -1,    55,
      -1,    44,    -1,    -1,    42,    55
};
...
{
       0,     3,     6,     8,     9,    13,    42,    45,    46,    47,
      48,    49,    50,    52,    53,    61,    62,    63,    11,    51,
       4,    48,    54,    56,    57,     0,    47,    33,     3,    55,
      57,    58,    59,    60,    46,    15,    18,    19,    54,    15,
      64,    12,    32,    24,    23,    14,    56,    56,    15,    11,
      47,    57,    58,    59,    12,     7,    50,    47
};
...
#line 1313 "src/parser.cpp"
  ...
  case 22: /* AddExp: PrimaryExp  */
#line 126 "src/parser.y"
               {(yyval.exprtype) = (yyvsp[0].exprtype);}
#line 1319 "src/parser.cpp"
    break;

  case 23: /* AddExp: AddExp ADD PrimaryExp  */
...
#line 1328 "src/parser.cpp"
  ...
  case 24: /* AddExp: AddExp SUB PrimaryExp  */
...
#line 1337 "src/parser.cpp"
  ...
  case 25: /* RelExp: AddExp  */
#line 142 "src/parser.y"
           {(yyval.exprtype) = (yyvsp[0].exprtype);}
#line 1343 "src/parser.cpp"
    break;

  case 26: /* RelExp: RelExp LES AddExp  */
...
#line 1352 "src/parser.cpp"
  ...
  case 27: /* LAndExp: RelExp  */
#line 152 "src/parser.y"
           {(yyval.exprtype) = (yyvsp[0].exprtype);}
#line 1358 "src/parser.cpp"
    break;

  case 28: /* LAndExp: LAndExp AND RelExp  */
...
#line 1367 "src/parser.cpp"
  ...
  case 29: /* LOrExp: LAndExp  */
#line 162 "src/parser.y"
            {(yyval.exprtype) = (yyvsp[0].exprtype);}
#line 1373 "src/parser.cpp"
    break;

  case 30: /* LOrExp: LOrExp OR LAndExp  */
...
#line 1398 "src/parser.cpp"
  ...
  case 33: /* DeclStmt: Type ID SEMICOLON  */
